...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { codigo_produto: @produto.codigo_produto, marca: @produto.marca, modelo: @produto.modelo, numero_serie: @produto.numero_serie } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codigo_produto: @produto.codigo_produto, marca: @produto.marca, modelo: @produto.modelo, numero_serie: @produto.numero_serie } }
